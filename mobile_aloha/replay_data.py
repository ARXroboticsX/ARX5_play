...
def main(opt):
    ...
    img_right_publisher = rospy.Publisher(config['camera_config']['original_image']['img_right_topic'],
                                          Image, queue_size=10)
    img_front_publisher = rospy.Publisher(config['camera_config']['original_image']['img_front_topic'],
                                          Image, queue_size=10)
    ...
    master_arm_right_publisher = rospy.Publisher(config['arm_config']['master_arm_right_topic'],
                                                 JointState, queue_size=10)
    puppet_arm_left_publisher = rospy.Publisher(config['arm_config']['puppet_arm_left_topic'],
                                                JointState, queue_size=10)
    puppet_arm_right_publisher = rospy.Publisher(config['arm_config']['puppet_arm_right_topic'],
                                                 JointState, queue_size=10)
